...
from data_loader.zyz_anns_dataset import ZYZanns_datasets
from data_loader.TextVR_dataset import ZYZOCRanns_datasets
...
def dataset_loader(dataset_name,
    ...
    elif 'zyzanns' in dataset_name:
        dataset = ZYZanns_datasets(**kwargs)
    elif dataset_name == "TextVR":
        dataset = ZYZOCRanns_datasets(**kwargs)
